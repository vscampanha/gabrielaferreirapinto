...
const Contact = () => (
  <section id="contacts" className={`w-[100%] px-[5%] my-[5%]`}>
    ...
    >
      ...
      <button
        type="submit"
        className="xs:invisible sm:visible sm:w-[40%] text-lg justify-center border border-transparent bg-main py-4 text-white hover:bg-[#B72F31] xs:place-self-center xs:mt-4 sm:place-self-end"
      >
